package onlinefrontlines.game
{
	...
	*/
	public class UnitStrengthProperties
	{	
		public var maxStrengthWithAmmo : int = 0;
		public var maxStrengthWithoutAmmo : int = 0;
		public var attackRange : int = 0;

		// Get strength depending on if we have ammo or not
		public function getStrength(hasAmmo : Boolean) : int
		{
